...
Founding goals of `newton-machine` `0.0.0`:
...
- [[docs/goals/when-to-choose-newton-over-harel]] — selection rule
- [[docs/goals/non-goals-of-newton-machine]] — refusals that are family law
- [[docs/goals/from-readme]] — harvested README (generated)

Decisions live under `docs/adr/`. Concepts under `docs/concepts/`. Edge cases under `docs/edge_cases/`. Roadmap: [[docs/plans/v0-crate-roadmap]].
